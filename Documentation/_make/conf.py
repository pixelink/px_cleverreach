# -*- coding: utf-8 -*-
#
# Pixelink Newsletter documentation build configuration file, created by
# TYPO3 extension sphinx on Thu, 19 Feb 2015 11:48:24 +0100.
#
...
htmlhelp_basename = 'newsletterdoc'
...
latex_documents = [
    ('Index', 'newsletter.tex', u'Pixelink Newsletter',
     u'', 'manual'),
]
...
pdf_documents = [
    ('Index', 'newsletter', u'Pixelink Newsletter',
     u''),
]
...
texinfo_documents = [
    ('Index', 'newsletter', u'Pixelink Newsletter',
     u'', 'Pixelink Newsletter', 'One line description of project.',
     'Miscellaneous'),
]
